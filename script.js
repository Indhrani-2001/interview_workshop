...
video.ontimeupdate = function () {
  ...
  secondsDisplay.textContent = `${String(minutes).padStart(2, "0")}:${String(
    displaySeconds
  ).padStart(2, "0")}`;
};
...
function nextPage() {
  window.location.href =
    "https://docs.google.com/forms/d/e/1FAIpQLSexFiVUrB9on_g-HC1ZhDkWsF-fw1XahI1RXCJXuAZtszYP2Q/viewform?usp=sf_link";
}
